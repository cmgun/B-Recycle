              ...
              <el-table-column prop="opt" label="操作" width="auto">
                <template #default="scope">
                  <div style="line-height: 1; font-size: 0;">
                    <el-button v-show="scope.row.accessStatus == '2' || scope.row.accessStatus == '3' || scope.row.accessStatus == '4'" type="info" @click="download(scope.row.userName)">下载文件</el-button>
